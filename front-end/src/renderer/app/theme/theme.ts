...
const UI_AURORA_ICE = Object.freeze({
  ...
  "--chip-err-fg": "#ffffff",
  "--timeline-label": "rgba(238, 242, 251, 0.9)",
  "--timeline-bg": "rgba(238, 242, 251, 0.9)",
  "--timeline-overlay-bg": "rgba(76, 76, 76, 0.72)",
  "--timeline-border": "rgba(180, 194, 223, 0.88)",
  "--timeline-bin": "#63d8ff",
  "--timeline-thumb": "#ffffff",
  "--timeline-thumb-border": "#7da3d1",
  "--timeline-disabled-opacity": "0.45",
  "--log-bg": "#ffffff",
...
const UI_LAVA_STAGE = Object.freeze({
  ...
  "--chip-err-fg": "#ffffff",
  "--timeline-label": "#d1a998",
  "--timeline-bg": "rgba(42, 31, 38, 0.92)",
  "--timeline-overlay-bg": "rgba(42, 31, 38, 0.72)",
  "--timeline-border": "rgba(106, 58, 69, 0.9)",
  "--timeline-bin": "#ff9a3c",
  "--timeline-thumb": "#ffd8be",
  "--timeline-thumb-border": "#8f4e5e",
  "--timeline-disabled-opacity": "0.45",
  "--log-bg": "#1a1418",
